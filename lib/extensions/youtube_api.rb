...
module YouTubeAPI
  ...
  private
    ...
    def get_comments(html)
      ...
      comment_sections.map!{|section|parse_comments(section)}
      comment_sections.compact!
      comment_sections.sort_by!{|x| x[:thumbs].to_i}
      comment_sections.reverse!
      comment_sections[0..1]
    end
